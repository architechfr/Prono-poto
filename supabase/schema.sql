...
-- ============================================================
-- JETONS DE BOOST — garantis côté serveur (trigger)
-- 50 jetons par phase (groupes / finale). ⚡×2 = 5 · ⭐×3 = 15.
-- On regagne des jetons en jouant : +2 bon résultat, +5 score exact.
-- Marge serveur (+20) pour absorber les états transitoires d'un upsert.
-- ============================================================
...
begin
  ...
  -- coût des boosts déjà posés dans cette phase + la nouvelle ligne
  ...
  -- jetons regagnés sur les matchs joués de la phase
